...
public:
    ...
    void
    PrintSparseView (std::ostream &stream = std::cout) const;

    void
    PrintDenseView (std::ostream &stream = std::cout) const;
    ...
    void
    SetFromTriplet (typename TripletsList::iterator beg, typename TripletsList::iterator end);
