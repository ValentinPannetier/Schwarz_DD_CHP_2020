            ...
            for (int j = start; j <= end; j++)
            {
                ...
                else if (j == end)  //bord de droite fictif
                {
                    for (int k = 0; k < num_lines; k++)
                    {
                        ...
                        {
                            write_mesh << j * delta_x << " " << 0 << " " << k * delta_y << " " << boundary_physical << 4 << " " << 0 << endl;
                        }  //bord bas
                        else
                        {
                            write_mesh << j * delta_x << " " << k * delta_y << " " << 0 << " " << k + j * num_lines << boundary_fictional << " " << 0 << endl;
                        }
                    }
                }
                else if (j == column_to_send_right)
                {
                    for (int k = 0; k < num_lines; k++)
                    {
                        if (k == 0)
                        {
                            write_mesh << j * delta_x << " " << k * delta_y << " " << 0 << " " << k + j * num_lines << boundary_physical << " " << 1 << " " << i + 1 << endl;
                        }  //bord haut
                        else if (k == num_lines - 1)
                        {
                            write_mesh << j * delta_x << " " << 0 << " " << k * delta_y << " " << k + j * num_lines << boundary_physical << " " << 1 << " " << i + 1 << endl;
                        }  //bord bas
                        else
                        {
                            write_mesh << j * delta_x << " " << k * delta_y << " " << 0 << " " << k + j * num_lines << inner_point << " " << 1 << " " << i + 1 << endl;
                        }
                    }
                }
                else
                    ...
                    {
                        {
                            ...
                            {
                                write_mesh << j * delta_x << " " << 0 << " " << k * delta_y << " " << k + j * num_lines << boundary_physical << " " << 0 << endl;
                            }  //bord haut
                            else
                            {
                                write_mesh << j * delta_x << " " << k * delta_y << " " << 0 << " " << k + j * num_lines << inner_point << " " << 0 << endl;
                            }
                        }
                    }
                }
            ...
            for (int j = start; j <= end; j++)
            {
                if (j == start)  //bord gauche fictif
                {
                    for (int k = 0; k < num_lines; k++)
                    {
                        ...
                        {
                            write_mesh << j * delta_x << " " << k * delta_y << " " << 0 << " " << boundary_physical << 4 << " " << 0 << endl;
                        }  //bord bas
                        else
                        {
                            write_mesh << j * delta_x << " " << k * delta_y << " " << 0 << " " << k + j * num_lines << boundary_fictional << " " << 0 << endl;
