...
void
charge (int me, int n, int np, int & iBeg, int & iEnd)
{
    int r = n % np;
    if (me < r)
    {
...
void
partitions (int num_points, int num_procs, int recovery_size, int * boundary_global_indices)
{
                ...
                for (int j = start; j <= end; j++)
                {
                    ...
                    else if (j == end)  //bord de droite fictif
                    {
                        for (int k = 0; k < num_lines; k++)
                        {
                            if (k == 0)
                            {
                                write_mesh << j * delta_x << " " << k * delta_y << " " << k + j * num_lines << " " << boundary_up_down << " " << 0 << endl;
                            }  //bord haut
                            else if (k == num_lines - 1)
                            {
                                write_mesh << j * delta_x << " " << k * delta_y << " " << k + j * num_lines << " " << boundary_up_down << " " << 0 << endl;
                            }  //bord bas
                            else
                            {
                                write_mesh << j * delta_x << " " << k * delta_y << " " << k + j * num_lines << " " << boundary_fictif << " " << 0 << endl;
                            }
                        }
                    }
                    else if (j == column_to_send_right)
                    {
                        for (int k = 0; k < num_lines; k++)
                        {
                            if (k == 0)
                            {
                                write_mesh << j * delta_x << " " << k * delta_y << " " << k + j * num_lines << " " << boundary_up_down << " " << 1 << " " << i + 1 << endl;
                            }  //bord haut
                            else if (k == num_lines - 1)
                            {
                                write_mesh << j * delta_x << " " << k * delta_y << " " << k + j * num_lines << " " << boundary_up_down << " " << 1 << " " << i + 1 << endl;
                            ...
                            {
                                write_mesh << j * delta_x << " " << k * delta_y << " " << k + j * num_lines << " " << inner_point << " " << 1 << " " << i + 1 << endl;
                            }
                        }
                    }
                    else
                        ...
                        {
                            {
                                ...
                                {
                                    write_mesh << j * delta_x << " " << k * delta_y << " " << k + j * num_lines << " " << inner_point << " " << 0 << endl;
                                }
                            }
                        }
                    }
